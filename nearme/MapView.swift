    ...
    ZStack {
      ...
      ScrollView { // Add ScrollView here
        VStack {
          ...
          .padding()
          // Map view
          Map(coordinateRegion: $viewModel.mapRegion, annotationItems: viewModel.filteredLocations) { location in
          ...
          HStack {
            Button(action: zoomIn) {
              Image("plus") // Use your custom plus button image
                .resizable()
                .scaledToFit()
                .frame(width: 30, height: 30) // Set the same size for both buttons
                .padding()
            ...
            Button(action: zoomOut) {
              Image("minus") // Use your custom minus button image
                .resizable()
                .scaledToFit()
                .frame(width: 30, height: 30) // Set the same size for both buttons
                .padding()
